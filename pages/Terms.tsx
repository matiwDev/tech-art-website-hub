    ...
    <div className="min-h-screen pt-32 pb-20 px-6 bg-zinc-950">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-4xl font-bold text-white font-sansation">Terms of Use</h1>
        </div>
        ...
        <div className="space-y-8 text-zinc-300 leading-relaxed animate-fade-in-up">
            <div className="p-8 md:p-10 bg-zinc-900/40 border border-zinc-800 rounded-3xl backdrop-blur-sm relative overflow-hidden">
                ...
                <h2 className="text-xl font-bold text-white mb-4 font-sansation">1. Professional Usage</h2>
                ...
                <h2 className="text-xl font-bold text-white mb-4 font-sansation">2. Intellectual Property</h2>
                <p className="mb-6 text-zinc-400">
                ...
                <h2 className="text-xl font-bold text-white mb-4 font-sansation">3. Limitation of Liability</h2>
